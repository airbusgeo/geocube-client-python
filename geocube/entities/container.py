...
class Container:
    ...
    @classmethod
    def new(cls, uri: str, record: Union[str, entities.Record], instance: Union[str, entities.VariableInstance],
            bands: List[int], dformat: entities.DataFormat,
        ...
        d = Dataset(record_id=entities.get_id(record), instance_id=entities.get_id(instance), bands=bands,
