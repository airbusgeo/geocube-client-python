...
_GEOCUBE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='IngestDatasets',
    full_name='geocube.Geocube.IngestDatasets',
    index=17,
    containing_service=None,
    input_type=geocube_dot_pb_dot_operations__pb2._INGESTDATASETSREQUEST,
    output_type=geocube_dot_pb_dot_operations__pb2._INGESTDATASETSRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
